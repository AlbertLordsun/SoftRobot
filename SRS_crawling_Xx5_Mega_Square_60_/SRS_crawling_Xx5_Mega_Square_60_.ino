...
ISR(TIMER1_COMPB_vect) //port12
{
  if(x1<=0.4)
  {
    if(0.32<=x1 && x1<=0.4){y1 = 249;}
    else if(0<= x1 && x1<=0.12){y1 = 249;}
    else y1=0;
    OCR1B = y1;
    x1 = x1+0.0002;           // count for 2000 times = 2s;
  }
  else x1=0;     
}
ISR(TIMER4_COMPC_vect) //port9
{
  if(x2<=0.4)
  {
    if(0.24<=x2 && x2<=0.4){y2 = 249;}
    else if(0<=x2 && x2<=0.04){y2 = 249;}
    else y2=0;
    OCR4C = y2;
    x2 = x2+0.0002;
  }
