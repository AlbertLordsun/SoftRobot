// Crawling with five segments via saw2 wave;
...
//  TCCR4A = 0; TCCR4B = 0; 
  ...
  TIMSK4 |= (1 << OCIE4B);     
  TIMSK4 |= (1 << OCIE4C);  
  // define the OCRnA range, for the frequency of 1000Hz
  OCR1A = 249;
  OCR3A = 249;
  OCR4A = 249;  
...
ISR(TIMER1_COMPB_vect) //port12
{
  if(x1<=0.4)
  {
    if(0.32<=x1 && x1<0.4){y1 = 590*(x1-0.32)+190;}
    else if(0<=x1 && x1<0.02){y1 = 590*(x1+0.08)+190;}
    else if(0.02<=x1 && x1<=0.12){y1 = -590*(x1+0.08)+308;}
    else y1=0;
    OCR1B = y1;
...
ISR(TIMER4_COMPC_vect) //port8
{
  if(x2<=0.4)
  {
    if(0.24<=x2 && x2<0.34){y2 = 590*(x2-0.24)+190;}
    else if(0.34<=x2 && x2<=0.4){y2 = -590*(x2-0.24)+308;}
    else if(0<=x2 && x2<=0.04){y2 = -590*(x2+0.16)+308;}
    else y2=0;
    OCR4C = y2;
    x2 = x2+0.0002;
  }
...
ISR(TIMER4_COMPB_vect) //port7
{
  if(x3<=0.4)
  {
    if(0.16<=x3 && x3<0.26){y3 = 590*(x3-0.16)+190;}
    else if(0.26<=x3 && x3<=0.36){y3 = -590*(x3-0.16)+308;}
    else y3=0;
    OCR4B = y3;
    x3 = x3+0.0002;           
  }
...
ISR(TIMER3_COMPC_vect) //port3
{
  if(x4<=0.4)
  {
    if(0.08<=x4 && x4<0.18){y4 = 590*(x4-0.08)+190;}
    else if(0.18<=x4 && x4<=0.28){y4 = -590*(x4-0.08)+308;}
    else y4=0;
    OCR3C = y4;
    x4 = x4+0.0002;
  }
...
ISR(TIMER3_COMPB_vect) //port2
{
  if(x5<=0.4)
  {
    if(0<=x5 && x5<0.1){y5 = 590*(x5)+190;}
    else if(0.1<=x5 && x5<=0.2){y5 = -590*(x5)+308;}
    else y5=0;
    OCR3B = y5;
    x5 = x5+0.0002;           
  }
...
//  if(x1<=1)
//  {
//    if(0<=x1 && x1<=0.1){y1 = 590*(x1)+190;}
//    else if(0.1<=x1 && x1<=0.2){y1 = -590*(x1)+308;}
//    else y1=0;
//    OCR1B = y1;
//    x1 = x1+0.0002;           
//  }
...
//  if(x2<=1)
//  {
//    if(0.2<=x2 && x2<=0.3){y2 = 590*(x2-0.2)+190;}
//    else if(0.3<=x2 && x2<=0.4){y2 = -590*(x2-0.2)+308;}
//    else y2=0;
//    OCR4C = y2;
//    x2 = x2+0.0002;
//  }
...
//  if(x3<=1)
//  {
//    if(0.4<=x3 && x3<=0.5){y3 = 590*(x3-0.4)+190;}
//    else if(0.5<=x3 && x3<=0.6){y3 = -590*(x3-0.4)+308;}
//    else y3=0;
//    OCR4B = y3;
//    x3 = x3+0.0002;           
//  }
...
//  if(x4<=1)
//  {
//    if(0.6<=x4 && x4<=0.7){y4 = 590*(x4-0.6)+190;}
//    else if(0.7<=x4 && x4<=0.8){y4 = -590*(x4-0.6)+308;}
//    else y4=0;
//    OCR3C = y4;
//    x4 = x4+0.0002;
//  }
...
//  if(x5<=1)
//  {
//    if(0.8<=x5 && x5<=0.9){y5 = 590*(x5-0.8)+190;}
//    else if(0.9<=x5 && x5<=1){y5 = -590*(x5-0.8)+308;}
//    else y5=0;
//    OCR3B = y5;
//    x5 = x5+0.0002;           
//  }
