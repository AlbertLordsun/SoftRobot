...
ISR(TIMER1_COMPB_vect) //port12
{
  if(x1<=1)
  {
    if(0.8<=x1 && x1<=1){y1 = -295*(x1-0.8)+249;}
    else y1=0;
    OCR1B = y1;
...
ISR(TIMER4_COMPC_vect) //port8
{
  if(x2<=1)
  {
    if(0.6<=x2 && x2<=0.8){y2 = -295*(x2-0.6)+249;}
    else y2=0;
    OCR4C = y2;
    x2 = x2+0.0002;
  }
...
ISR(TIMER4_COMPB_vect) //port7
{
  if(x3<=1)
  {
    if(0.4<=x3 && x3<=0.6){y3 = -295*(x3-0.4)+249;}
    else y3=0;
    OCR4B = y3;
    x3 = x3+0.0002;           
  }
...
ISR(TIMER3_COMPC_vect) //port3
{
  if(x4<=1)
  {
    if(0.2<=x4 && x4<=0.4){y4 = -295*(x4-0.2)+249;}
    else y4=0;
    OCR3C = y4;
    x4 = x4+0.0002;
  }
...
//  if(x2<=1)
//  {
//    if(0.2<=x2 && x2<=0.4){y2 = -295*(x2-0.2)+249;}
//    else y2=0;
//    OCR4C = y2;
//    x2 = x2+0.0002;
//  }
...
//  if(x4<=1)
//  {
//    if(0.6<=x4 && x4<=0.8){y4 = -295*(x4-0.6)+249;}
//    else y4=0;
//    OCR3C = y4;
//    x4 = x4+0.0002;
//  }
...
//  if(x5<=1)
//  {
//    if(0.8<=x5 && x5<=1){y5 = -295*(x5-0.8)+249;}
//    else y5=0;
//    OCR3B = y5;
//    x5 = x5+0.0002;           
//  }
