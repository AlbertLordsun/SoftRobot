...
ISR(TIMER1_COMPB_vect) //port12
{
  if(x1<=1)
  {
    if(0.8<=x1 && x1<=1){y1 = 59*sin((x1-0.8)/0.2*pi)+190;}
    else y1=0;
    OCR1B = y1;
    x1 = x1+0.0005;           // stride duration = 1/(1000Hz*step length);
  }
  else x1=0;     
}
ISR(TIMER4_COMPC_vect) //port8
{
  if(x2<=1)
  {
    if(0.6<=x2 && x2<=0.8){y2 = 59*sin((x2-0.6)/0.2*pi)+190;}
    else y2=0;
    OCR4C = y2;
    x2 = x2+0.0005;
  }
...
ISR(TIMER4_COMPB_vect) //port7
{
  if(x3<=1)
  {
    if(0.4<=x3 && x3<=0.6){y3 = 59*sin((x3-0.4)/0.2*pi)+190;}
    else y3=0;
    OCR4B = y3;
    x3 = x3+0.0005;           
  }
...
ISR(TIMER3_COMPC_vect) //port3
{
  if(x4<=1)
  {
    if(0.2<=x4 && x4<=0.4){y4 = 59*sin((x4-0.2)/0.2*pi)+190;}
    else y4=0;
    OCR3C = y4;
    x4 = x4+0.0005;
  }
...
//  if(x1<=1)
//  {
//    if(0<=x1 && x1<=0.2){y1 = 59*sin(x1/0.2*pi)+190;}
//    else y1=0;
//    OCR1B = y1;
//    x1 = x1+0.0002;           
//  }
...
//  if(x2<=1)
//  {
//    if(0.2<=x2 && x2<=0.4){y2 = 59*sin((x2-0.2)/0.2*pi)+190;}
//    else y2=0;
//    OCR4C = y2;
//    x2 = x2+0.0002;
//  }
...
//  if(x4<=1)
//  {
//    if(0.6<=x4 && x4<=0.8){y4 = 59*sin((x4-0.6)/0.2*pi)+190;}
//    else y4=0;
//    OCR3C = y4;
//    x4 = x4+0.0002;
//  }
...
//  if(x5<=1)
//  {
//    if(0.8<=x5 && x5<=1){y5 = 59*sin((x5-0.8)/0.2*pi)+190;}
//    else y5=0;
//    OCR3B = y5;
//    x5 = x5+0.0002;           
//  }
