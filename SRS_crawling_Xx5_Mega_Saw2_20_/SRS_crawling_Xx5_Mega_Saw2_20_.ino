...
ISR(TIMER1_COMPB_vect) //port12
{
  if(x1<=0.8)
  {
    if(0.64<=x1 && x1<0.74){y1 = 590*(x1-0.64)+190;}
    else if(0.74<=x1 && x1<0.8){y1 = -590*(x1-0.64)+308;}
    else if(0<=x1 && x1<=0.04){y1 = -590*(x1+0.16)+308;}
    else y1=0;
    OCR1B = y1;
...
ISR(TIMER4_COMPC_vect) //port8
{
  if(x2<=0.8)
  {
    if(0.48<=x2 && x2<0.58){y2 = 590*(x2-0.48)+190;}
    else if(0.58<=x2 && x2<=0.68){y2 = -590*(x2-0.48)+308;}
    else y2=0;
    OCR4C = y2;
    x2 = x2+0.0002;
  }
...
ISR(TIMER4_COMPB_vect) //port7
{
  if(x3<=0.8)
  {
    if(0.32<=x3 && x3<0.42){y3 = 590*(x3-0.32)+190;}
    else if(0.42<=x3 && x3<=0.52){y3 = -590*(x3-0.32)+308;}
    else y3=0;
    OCR4B = y3;
    x3 = x3+0.0002;           
  }
...
ISR(TIMER3_COMPC_vect) //port3
{
  if(x4<=0.8)
  {
    if(0.16<=x4 && x4<0.26){y4 = 590*(x4-0.16)+190;}
    else if(0.26<=x4 && x4<=0.36){y4 = -590*(x4-0.16)+308;}
    else y4=0;
    OCR3C = y4;
    x4 = x4+0.0002;
  }
