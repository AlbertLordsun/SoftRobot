...
ISR(TIMER1_COMPB_vect) //port12
{
  if(x1<=0.4)
  {
    if(0.32<=x1 && x1<=0.4){y1 = -295*(x1-0.32)+249;}
    else if(0<=x1 && x1<=0.12){y1 = -295*(x1+0.08)+249;}
    else y1=0;
    OCR1B = y1;
...
ISR(TIMER4_COMPC_vect) //port8
{
  if(x2<=0.4)
  {
    if(0.24<=x2 && x2<=0.4){y2 = -295*(x2-0.24)+249;}
    else if(0<=x2 && x2<=0.04){y2 = -295*(x2+0.16)+249;}
    else y2=0;
    OCR4C = y2;
    x2 = x2+0.0002;
  }
...
ISR(TIMER4_COMPB_vect) //port7
{
  if(x3<=0.4)
  {
    if(0.16<=x3 && x3<=0.36){y3 = -295*(x3-0.16)+249;}
    else y3=0;
    OCR4B = y3;
    x3 = x3+0.0002;           
  }
...
ISR(TIMER3_COMPC_vect) //port3
{
  if(x4<=0.4)
  {
    if(0.08<=x4 && x4<=0.28){y4 = -295*(x4-0.08)+249;}
    else y4=0;
    OCR3C = y4;
    x4 = x4+0.0002;
  }
