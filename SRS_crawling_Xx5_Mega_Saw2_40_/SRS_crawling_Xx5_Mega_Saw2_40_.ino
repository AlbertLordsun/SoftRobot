...
ISR(TIMER1_COMPB_vect) //port12
{
  if(x1<=0.6)
  {
    if(0.48<=x1 && x1<0.58){y1 = 590*(x1-0.48)+190;}
    else if(0.58<=x1 && x1<0.6){y1 = -590*(x1-0.48)+308;}
    else if(0<=x1 && x1<=0.08){y1 = -590*(x1+0.12)+308;}
    else y1=0;
    OCR1B = y1;
...
ISR(TIMER4_COMPC_vect) //port8
{
  if(x2<=0.6)
  {
    if(0.36<=x2 && x2<0.46){y2 = 590*(x2-0.36)+190;}
    else if(0.46<=x2 && x2<=0.56){y2 = -590*(x2-0.36)+308;}
    else y2=0;
    OCR4C = y2;
    x2 = x2+0.0002;
  }
...
ISR(TIMER4_COMPB_vect) //port7
{
  if(x3<=0.6)
  {
    if(0.24<=x3 && x3<0.34){y3 = 590*(x3-0.24)+190;}
    else if(0.34<=x3 && x3<=0.44){y3 = -590*(x3-0.24)+308;}
    else y3=0;
    OCR4B = y3;
    x3 = x3+0.0002;           
  }
...
ISR(TIMER3_COMPC_vect) //port3
{
  if(x4<=0.6)
  {
    if(0.12<=x4 && x4<0.22){y4 = 590*(x4-0.12)+190;}
    else if(0.22<=x4 && x4<=0.32){y4 = -590*(x4-0.12)+308;}
    else y4=0;
    OCR3C = y4;
    x4 = x4+0.0002;
  }
