...
ISR(TIMER1_COMPB_vect) //port12
{
  if(x1<=1)
  {
    if(0.8<=x1 && x1<=0.9){y1 = 590*(x1-0.8)+190;}
    else if(0.9<=x1 && x1<=1){y1 = -590*(x1-0.8)+308;}
    else y1=0;
    OCR1B = y1;
...
ISR(TIMER4_COMPC_vect) //port8
{
  if(x2<=1)
  {
    if(0.6<=x2 && x2<=0.7){y2 = 590*(x2-0.6)+190;}
    else if(0.7<=x2 && x2<=0.8){y2 = -590*(x2-0.6)+308;}
    else y2=0;
    OCR4C = y2;
    x2 = x2+0.0002;
  }
...
ISR(TIMER3_COMPC_vect) //port3
{
  if(x4<=1)
  {
    if(0.2<=x4 && x4<=0.3){y4 = 590*(x4-0.2)+190;}
    else if(0.3<=x4 && x4<=0.4){y4 = -590*(x4-0.2)+308;}
    else y4=0;
    OCR3C = y4;
    x4 = x4+0.0002;
  }
